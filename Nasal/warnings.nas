...
var warning_system = {
       init : func {
            ...
            stall.condition = func() {
				...
				return ((getprop("/position/altitude-agl-ft") > 400) and (((ias <= 150) and (flaps <=0.29 )) or ((ias <= 135) and (flaps == 0.529)) or ((ias <= 120) and (flaps >= 74))));
            };
    ...
    #       };
			...
			emer_conf.condition = func() {
				return (((getprop("/controls/electric/engine/generator") == 1) and (getprop("/controls/engines/engine/cutoff"))) and ((getprop("/controls/electric/engine[1]/generator") == 1) and (getprop("/controls/engines/engine[1]/cutoff"))));
			}
